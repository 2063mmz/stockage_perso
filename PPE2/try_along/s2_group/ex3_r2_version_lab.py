...
def main():
    ...
    # Cette fois, c'est lecture des fichiers ver stdin plutôt que ex2r1
    ...
    with open("Extraction_du_lexique.csv", "w", encoding="utf-8") as f:
        # Les titres
    ...
    print("Le fichier du resultat bien cree.")
